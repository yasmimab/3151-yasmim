<div id="main" class="container-fluid">
	<div id="top" class="row">
		...
		<div class="col-md-2">
			...
			<a href="?page=fadd_usu" class="btn btn-primary pull-right h2"><i class='bx bx-plus-medical'></i> Usuário</a> 
		</div>
	</div>
			...
			<div class="table-responsive col-xs-12">
				<?php
					...
					while($info = mysqli_fetch_array($data_all)){ 
						...
						echo "<a class='btn btn-outline-info btn-xs' href=?page=view_usu&id=".$info['id']."> <i class='bx bxs-user-detail'></i> </a>";
						echo "<a class='btn btn-outline-warning btn-xs' href=?page=fedita_usu&id=".$info['id']."> <i class='bx bxs-edit-alt'></i> </a>";
						if($info['ativo'] == 1){
							echo "<a class='btn btn-outline-danger btn-xs'  href=?page=block_usu&id=".$info['id']."> <i class='bx bx-block'></i> </a>";
						}else if($info['ativo'] == 0){
							echo "<a class='btn btn-outline-success btn-xs'  href=?page=ativa_usu&id=".$info['id']."><i class='bx bx-lock-open'></i></a></div></td>";
						}
					}
					echo "</tr></tbody></table>";
				?>				
