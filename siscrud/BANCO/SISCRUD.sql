...
-- Copiando dados para a tabela siscrud.aluno: 5 rows
...
CREATE TABLE IF NOT EXISTS `disciplina` (
  ...
  `sigla_disc` varchar(4) DEFAULT NULL,
  `ch_disc` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_disc`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela siscrud.disciplina: ~2 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `produto` (
  `id_rod` int(11) NOT NULL AUTO_INCREMENT,
  `nome_prod` varchar(30) DEFAULT NULL,
  `preco_prod` double DEFAULT NULL,
  `qntde_prod` int(11) DEFAULT NULL,
  `qntde_min_estoque` int(11) DEFAULT NULL,
  `qntde_max_estoque` int(11) DEFAULT NULL,
...
-- Copiando dados para a tabela siscrud.produto: ~0 rows (aproximadamente)
...
REPLACE INTO `usuario` (`id`, `nome`, `usuario`, `senha`, `email`, `nivel`, `ativo`, `dt_cadastro`) VALUES
	...
	(7, 'FABIANA', 'ERERE', '8f277e029cdcd437865a39f076451784e0594b1e', 'ERERER@TESTE.COM', 2, 1, '2023-03-17 00:00:00');
